...
public class ApiService
{
    ...
    /// <summary>
    /// Trả về URL để stream/download file audio WAV trực tiếp.
    /// GET /api/v1/tts/audio/{filename}
    /// </summary>
    public string GetAudioStreamUrl(string filename) =>
        $"{_baseUrl}/api/v1/tts/audio/{Uri.EscapeDataString(filename)}";
